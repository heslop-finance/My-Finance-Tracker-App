...
useEffect(()=>{setSyncedTransactions(prev=>{const seen=new Map();return prev.filter(t=>{const key=`${t.date}|${Math.abs(t.amount)}|${t.ledgerlyCategory||''}`;if(seen.has(key))return false;seen.set(key,true);return true;});});},[]);
